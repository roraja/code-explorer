...
| `ClassPromptStrategy.ts` | `class`, `interface`, `enum` | Class structure, member analysis, member access patterns, lifecycle |
| `VariablePromptStrategy.ts` | `variable` | Data mutation tracking, variable lifecycle, data flow |
